...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2022 a las 05:12:59
...
CREATE TABLE `percepcion` (
  `id_cpto` int(18) NOT NULL,
  `Descripcion` varchar(60) NOT NULL,
  `id_periodo` int(18) NOT NULL,
  `Dia` int(18) NOT NULL,
  `Mes` int(18) NOT NULL,
  `Nom_Per` varchar(2) NOT NULL,
  `Tipo_nom` int(18) NOT NULL,
  `Valor` int(18) NOT NULL,
  `Dia_per` int(18) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tipo_nomina` (`idtipo_nomina`, `descripcion`) VALUES
(1, 'Obrero'),
(2, 'Tecnicos'),
(3, 'Supervisores');
...
--
ALTER TABLE `percepcion`
  MODIFY `id_cpto` int(18) NOT NULL AUTO_INCREMENT;
